      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-black/5">
        <div className="mx-auto max-w-9xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            <Link
              to="/comparazione-estratto-ai"
              className="inline-flex items-center gap-2 rounded-full bg-[#1D4ED8] px-4 py-2 text-white text-sm font-medium shadow hover:brightness-110"
            >
              Comparazione AI
            </Link>
